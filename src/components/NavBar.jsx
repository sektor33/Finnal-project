    ...
    <div className={styles.bar}>
      <div className="container">
        <nav className={styles.pill} aria-label="Main Navigation">
          ...
          {/* Logout მარჯვენა მხარეს (მხოლოდ ავტორიზებულისთვის) */}
          {isAuthenticated && (
            <button
              onClick={logout}
...
function GearIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" strokeWidth="1.7" {...props}>
      ...
      <path
        d="M19 12a7 7 0 0 0-.2-1.6l2-1.6-2-3.4-2.4 1a7 7 0 0 0-2.2-1.3L12 2 9.8 4.1a7 7 0 0 0-2.2 1.3l-2.4-1-2 3.4 2 1.6A7 7 0 0 0 5 12c0 .5.1 1.1.2 1.6l-2 1.6 2 3.4 2.4-1a7 7 0 0 0 2.2 1.3L12 22l2.2-2.1a7 7 0 0 0 2.2-1.3l2.4 1 2-3.4-2-1.6c.1-.5.2-1.1.2-1.6Z"
        stroke="currentColor"
      />
    </svg>
  );
